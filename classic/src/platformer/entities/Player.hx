...
import haxepunk.input.gamepads.XBOX_GAMEPAD;
...
class Player extends Physics
{
	...
	{
		gamepad.defineButton("left", [XBOX_GAMEPAD.DPAD_LEFT]);
		gamepad.defineButton("right", [XBOX_GAMEPAD.DPAD_RIGHT]);
		gamepad.defineButton("jump", [XBOX_GAMEPAD.A_BUTTON]);
		gamepad.defineButton("switch_jump_mode", [XBOX_GAMEPAD.B_BUTTON]);
		gamepad.defineAxis("left", XBOX_GAMEPAD.LEFT_ANALOGUE_X, -0.1, -1);
		gamepad.defineAxis("right", XBOX_GAMEPAD.LEFT_ANALOGUE_X, 0.1, 1);
		gamepad.defineAxis("jump", XBOX_GAMEPAD.LEFT_ANALOGUE_Y, -0.5, -1);
		gamepad.defineAxis("jump", XBOX_GAMEPAD.RIGHT_ANALOGUE_Y, -0.5, -1);
	}
